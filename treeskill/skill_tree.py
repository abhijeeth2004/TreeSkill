...
from treeskill.skill import SKILL_FILE, load as _load_skill, save as _save_skill
...
class SkillTree:
    ...
    def collect_tools(self, dotpath: str = "") -> List:
        ...
        """
        from treeskill.schema import ToolRef
...
def resolve_skill_tools(
    ...
    """
    from treeskill.tools import BaseTool, HTTPTool, MCPTool
