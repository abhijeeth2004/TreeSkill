...
EVO_LLM_TEMPERATURE=0.7

EVO_STORAGE_TRACE_PATH=./data/traces.jsonl
EVO_STORAGE_SKILL_PATH=./skills

EVO_APO_MAX_STEPS=3
EVO_APO_GRADIENT_ACCUMULATION_STEPS=5

EVO_REWARD_ENABLED=false
EVO_REWARD_AUTO_JUDGE=false
```
...
示例：
- `.env`: `EVO_LLM_MODEL=gpt-3.5`
- `config.yaml`: `llm.model: gpt-4o`
- 环境变量: `export EVO_LLM_MODEL=claude-3`
